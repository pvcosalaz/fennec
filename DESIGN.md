...
| 2026-07-03 | ALL bottom sheets share one behavior: finger-follow swipe-down to dismiss (`useSheetDismiss`), true-bottom anchor (`SHEET_BOTTOM`), slide-up entrance (`SHEET_ENTER`) | Paco: "así deberían funcionar todos los avisos del proyecto. Absolutamente todos." One hook, 10 sheets wired; also fixed the fill:both entrance animation overriding drag transforms |
