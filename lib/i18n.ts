...
i18n.addResourceBundle("en", "translation", {
  ...
  abRate: "Your rate per show", abRateSetup: "Set up your rate", abRateEdit: "Adjust",
  abMinFee: "Minimum per show",
  abRateHint: "Built from your estimated monthly costs — not from what venues offer.",
...
i18n.addResourceBundle("es", "translation", {
  ...
  abRate: "Tu tarifa por show", abRateSetup: "Arma tu tarifa", abRateEdit: "Ajustar",
  abMinFee: "Mínimo por show",
  abRateHint: "Sale de tus gastos mensuales estimados — no de lo que ofrezca el venue.",
