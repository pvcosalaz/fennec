...
i18n.addResourceBundle("en", "translation", {
  ...
  quotesOut: "Quotes out", karma: "Karma", activeProjects: "Active projects",
...
i18n.addResourceBundle("es", "translation", {
  ...
  quotesOut: "Por cobrar", karma: "Karma", activeProjects: "Proyectos activos",
...
i18n.addResourceBundle("en", "translation", {
  ...
  prQueEscuchas: "What do you hear at this moment…", prMasAcciones: "More actions",
  prDaParaRecibir: "Give to get.",
  chSemanaAnterior: "Previous week", chSemanaSiguiente: "Next week",
  chBorrarTarea: "Delete task", chContentHub: "Content Hub",
  chFechaLarga: "{{mes}} {{dia}}, {{anio}}",
  mclTuIdea: "Your idea", mclGenerando: "Generating…", mclFormatos: "Formats",
  qgSubtotal: "Subtotal", qgArrancarProyecto: "Start the project?",
  qgExplicaMinimo: "<b>Minimum.</b> What you need per project for the month to close. Your monthly target of <b>{{objetivo}}</b> split across the <b>{{proyectos}}</b> project you can take at {{horas}}h each. Charge under this and the project costs you money.",
  qgExplicaMinimo_other: "<b>Minimum.</b> What you need per project for the month to close. Your monthly target of <b>{{objetivo}}</b> split across the <b>{{proyectos}}</b> projects you can take at {{horas}}h each. Charge under this and the project costs you money.",
  qgExplicaRecomendado: "<b>Recommended.</b> Your minimum adjusted for who's paying. {{tipo}} sits at <b>×{{mult}}</b> of a baseline job.",
  qgExplicaRecomendadoTope: "<b>Recommended.</b> Your minimum adjusted for who's paying. {{tipo}} sits at <b>×{{mult}}</b> of a baseline job, which lands below your minimum, so the minimum wins.",
  rpEnlaceInvalido: "This link has expired or is invalid.",
  rpPideOtro: "Request a new one from the login screen.",
  rpNuevaContrasena: "Set a new password",
  pcMinimo: "Minimum", pcMinimoTotal: "Minimum total", pcRecomendadoTotal: "Recommended total",
  pcObjetivoMensual: "Your monthly target", pcTuTarifaRonda: "Your rate lands around",
  pcPrecioListo: "Your price is set. Now get paid.",
  tdNotaPrecisa: "Leave a precise note at this moment…", tdVolumen: "Volume",
  tdSilenciar: "Mute", tdActivarSonido: "Unmute", tdPausa: "Pause", tdReproducir: "Play",
  tdAlejar: "Zoom out", tdZoomNormal: "Reset zoom", tdAcercar: "Zoom in",
  dbFennecDb: "FENNEC dB", dbQueEsFennecDb: "What is FENNEC dB?",
  dbAlcanceVerificado: "Verified reach", dbTusNumeros: "Your Numbers",
  dbComoSeActualiza: "How is it updated?",
  amCargandoTracks: "Loading tracks...", amCerrar: "Close",
  amSinTracks: "No tracks available right now. Check back later!",

}, true, true);
i18n.addResourceBundle("es", "translation", {
  pcClose: "Cerrar", pcMyExpenses: "Mis gastos",
  prQueEscuchas: "¿Qué escuchas en este momento…", prMasAcciones: "Más acciones",
  prDaParaRecibir: "Da para recibir.",
  chSemanaAnterior: "Semana anterior", chSemanaSiguiente: "Semana siguiente",
  chBorrarTarea: "Eliminar tarea", chContentHub: "Centro de contenido",
  chFechaLarga: "{{dia}} de {{mes}} {{anio}}",
  mclTuIdea: "Tu idea", mclGenerando: "Generando…", mclFormatos: "Formatos",
  qgSubtotal: "Subtotal", qgArrancarProyecto: "¿Arrancamos el proyecto?",
  qgExplicaMinimo: "<b>Mínimo.</b> Lo que necesitas por proyecto para cerrar el mes. Tu objetivo mensual de <b>{{objetivo}}</b> repartido entre el <b>{{proyectos}}</b> proyecto que alcanzas a tomar, de {{horas}}h cada uno. Cobra menos y el proyecto te cuesta dinero.",
  qgExplicaMinimo_other: "<b>Mínimo.</b> Lo que necesitas por proyecto para cerrar el mes. Tu objetivo mensual de <b>{{objetivo}}</b> repartido entre los <b>{{proyectos}}</b> proyectos que alcanzas a tomar, de {{horas}}h cada uno. Cobra menos y el proyecto te cuesta dinero.",
  qgExplicaRecomendado: "<b>Recomendado.</b> Tu mínimo ajustado según quién paga. {{tipo}} va en <b>×{{mult}}</b> de un trabajo base.",
  qgExplicaRecomendadoTope: "<b>Recomendado.</b> Tu mínimo ajustado según quién paga. {{tipo}} va en <b>×{{mult}}</b> de un trabajo base, que queda por debajo de tu mínimo, así que gana el mínimo.",
  rpEnlaceInvalido: "Este enlace expiró o no es válido.",
  rpPideOtro: "Pide uno nuevo desde la pantalla de acceso.",
  rpNuevaContrasena: "Define una contraseña nueva",
  pcMinimo: "Mínimo", pcMinimoTotal: "Total mínimo", pcRecomendadoTotal: "Total recomendado",
  pcObjetivoMensual: "Tu objetivo mensual", pcTuTarifaRonda: "Tu tarifa ronda los",
  pcPrecioListo: "Ya tienes tu precio. Ahora a cobrar.",
  tdNotaPrecisa: "Deja una nota exacta en este momento…", tdVolumen: "Volumen",
  tdSilenciar: "Silenciar", tdActivarSonido: "Activar sonido", tdPausa: "Pausa", tdReproducir: "Reproducir",
  tdAlejar: "Alejar", tdZoomNormal: "Zoom normal", tdAcercar: "Acercar",
  dbFennecDb: "FENNEC dB", dbQueEsFennecDb: "¿Qué es el FENNEC dB?",
  dbAlcanceVerificado: "Alcance verificado", dbTusNumeros: "Tus números",
  dbComoSeActualiza: "¿Cómo se actualiza?",
  amCargandoTracks: "Cargando tracks...", amCerrar: "Cerrar",
  amSinTracks: "No hay tracks disponibles ahora. ¡Vuelve más tarde!",
...
i18n.addResourceBundle("en", "translation", {
  ...
  ddActivos: "active",
  ddIngresos: "Income", ddCobradoMes: "collected this month",
  ddPorCobrar: "{{amount}} still owed", ddSinCobrar: "nothing owed",
  ddProgramados: "Videos to publish", ddEstaSemana: "this week", ddSemanaVacia: "nothing this week",
  sgAlguien: "Someone", sgComento: "{{user}} commented on your post",
  sgVerArrow: "View \u2192", sgCobrarArrow: "Collect \u2192", sgSeguirArrow: "Follow up \u2192",
  sgSinAnticipo: "{{name}} is in production with no deposit",
  sgCotizacionSinRespuesta: "{{name}}: no reply in {{days}} days",
  sgBorradores_one: "{{count}} quote written but not sent",
  sgBorradores_other: "{{count}} quotes written but not sent",
  sgEntregadoSinCobrar: "{{name}} delivered and still unpaid",
  sgVencido: "{{name}} is {{days}} days past deadline",
  sgEntregaCerca: "{{name}} is due in {{days}} days",
  sgEntregaHoy: "{{name}} is due today",
  sgPostHoy_one: "{{count}} post scheduled for today",
  sgPostHoy_other: "{{count}} posts scheduled for today",
  sgTodoAlDia: "Nothing needs you right now", sgTodoAlDiaAccion: "Plan \u2192",
  tdEnterEnvia: "ENTER to send · ⌥←→ to nudge",
  tdAtrasarNota: "One second back", tdAdelantarNota: "One second forward",
...
i18n.addResourceBundle("es", "translation", {
  ...
  ddActivos: "activos",
  ddIngresos: "Ingresos", ddCobradoMes: "cobrado este mes",
  ddPorCobrar: "faltan {{amount}}", ddSinCobrar: "nada por cobrar",
  ddProgramados: "Videos por publicar", ddEstaSemana: "esta semana", ddSemanaVacia: "nada esta semana",
  sgAlguien: "Alguien", sgComento: "{{user}} comentó tu post",
  sgVerArrow: "Ver \u2192", sgCobrarArrow: "Cobrar \u2192", sgSeguirArrow: "Dar seguimiento \u2192",
  sgSinAnticipo: "{{name}} está en producción sin anticipo",
  sgCotizacionSinRespuesta: "{{name}}: sin respuesta en {{days}} días",
  sgBorradores_one: "{{count}} cotización escrita sin enviar",
  sgBorradores_other: "{{count}} cotizaciones escritas sin enviar",
  sgEntregadoSinCobrar: "{{name}} entregado y sin cobrar",
  sgVencido: "{{name}} lleva {{days}} días vencido",
  sgEntregaCerca: "{{name}} se entrega en {{days}} días",
  sgEntregaHoy: "{{name}} se entrega hoy",
  sgPostHoy_one: "{{count}} post programado para hoy",
  sgPostHoy_other: "{{count}} posts programados para hoy",
  sgTodoAlDia: "Nada requiere tu atención ahora", sgTodoAlDiaAccion: "Planear \u2192",
  tdEnterEnvia: "ENTER envía · ⌥←→ ajusta",
  tdAtrasarNota: "Un segundo atrás", tdAdelantarNota: "Un segundo adelante",
...
/* Artist Business — eventos y tarifa por show (2026-08-18) */
i18n.addResourceBundle("en", "translation", {
  abKicker: "Artist Business", abTitle: "Your career, in events",
  abEarned: "Earned", abInvested: "Invested", abNet: "Net",
  abThisMonth: "this month", abPending: "still owed",
  abAll: "All", abGigs: "Gigs", abRecordings: "Recordings", abReleases: "Releases",
  abAddEvent: "Add event", abKindGig: "Gig", abKindRecording: "Recording", abKindRelease: "Release",
  abEmpty: "Nothing here yet. Book it, record it, release it. Log it here.",
  abStHold: "Hold", abStConfirmed: "Confirmed", abStPlayed: "Played", abStPaid: "Paid",
  abStPlanned: "Planned", abStInProgress: "In progress", abStDone: "Done",
  abStScheduled: "Scheduled", abStReleased: "Released",
  abTitleField: "Title", abDate: "Date", abVenue: "Venue", abCity: "City",
  abFee: "Fee", abDeposit: "Deposit received", abCost: "Costs",
  abRecouped: "Recouped so far", abReleaseType: "Format", abNotes: "Notes",
  abSave: "Save", abCancel: "Cancel", abDelete: "Delete",
  abRate: "Rate calculator", abRateSetup: "Set up your rate", abRateEdit: "Adjust",
  abMinFee: "Minimum per show",
  abRateHint: "Find the minimum you should charge per show.",
  abSetupTitle: "Your rate per show",
  abSetupIntro: "Everything below is a monthly estimate. Estimates are enough to quote right. This is pricing, not accounting.",
  abSecLife: "Life · monthly estimate", abSecProject: "Your project · monthly estimate",
  abSecAdjust: "Adjustments", abSecReality: "The reality of your shows",
  abFldEquipo: "Gear (prorated)", abFldSueldos: "Team salaries",
  abFldMarketing: "Marketing", abFldSesiones: "Sessions (recording, photos)",
  abFldEnsayos: "Rehearsals & transport", abFldDistribucion: "Digital distribution",
  abFldOtros: "Other",
  abFldTax: "Taxes %", abFldEmergency: "Emergency fund (monthly)",
  abFldLiveShare: "% of your income that comes from live shows",
  abFldShows: "Shows you realistically expect per month",
  abFldShowsHint: "What you actually get booked, not how many would fit.",
  abFldCommission: "Manager / booking commission %",
  abFldShowCost: "Average direct cost per show (band, travel)",
  abNeed: "You need per month", abLiveCover: "Live must cover", abNetShow: "Net per show",
  abSetupDone: "Save my rate",
}, true, true);
i18n.addResourceBundle("es", "translation", {
  abKicker: "Negocio de artista", abTitle: "Tu carrera, en eventos",
  abEarned: "Cobrado", abInvested: "Invertido", abNet: "Neto",
  abThisMonth: "este mes", abPending: "por cobrar",
  abAll: "Todo", abGigs: "Fechas", abRecordings: "Grabaciones", abReleases: "Lanzamientos",
  abAddEvent: "Agregar evento", abKindGig: "Fecha", abKindRecording: "Grabación", abKindRelease: "Lanzamiento",
  abEmpty: "Aún no hay nada. Tocada, grabación o lanzamiento: regístralo aquí.",
  abStHold: "Apartada", abStConfirmed: "Confirmada", abStPlayed: "Tocada", abStPaid: "Pagada",
  abStPlanned: "Planeada", abStInProgress: "En curso", abStDone: "Lista",
  abStScheduled: "Programado", abStReleased: "Publicado",
  abTitleField: "Título", abDate: "Fecha", abVenue: "Venue", abCity: "Ciudad",
  abFee: "Pago", abDeposit: "Anticipo recibido", abCost: "Costos",
  abRecouped: "Recuperado hasta hoy", abReleaseType: "Formato", abNotes: "Notas",
  abSave: "Guardar", abCancel: "Cancelar", abDelete: "Borrar",
  abRate: "Calculadora de tarifa", abRateSetup: "Arma tu tarifa", abRateEdit: "Ajustar",
  abMinFee: "Mínimo por show",
  abRateHint: "Encuentra el mínimo que debes cobrar por show.",
  abSetupTitle: "Tu tarifa por show",
  abSetupIntro: "Todo lo de abajo es un estimado mensual. Con estimados alcanza para cotizar bien: esto es precio, no contabilidad.",
  abSecLife: "Vida · estimado mensual", abSecProject: "Tu proyecto · estimado mensual",
  abSecAdjust: "Ajustes", abSecReality: "La realidad de tus shows",
  abFldEquipo: "Equipo (prorrateado)", abFldSueldos: "Sueldos del equipo",
  abFldMarketing: "Marketing", abFldSesiones: "Sesiones (grabación, fotos)",
  abFldEnsayos: "Ensayos y transporte", abFldDistribucion: "Distribución digital",
  abFldOtros: "Otros",
  abFldTax: "Impuestos %", abFldEmergency: "Fondo de emergencia (mensual)",
  abFldLiveShare: "% de tu ingreso que viene del vivo",
  abFldShows: "Shows realistas al mes",
  abFldShowsHint: "Los que de verdad te salen, no los que cabrían.",
  abFldCommission: "Comisión de manager / booking %",
  abFldShowCost: "Costo directo promedio por show (banda, viáticos)",
...
/* Artist Business · reestructura organizacion-primero + cotizar show (2026-08-19) */
i18n.addResourceBundle("en", "translation", {
  aqUpNext: "Up next", aqToday: "Today",
  aqInDays_one: "in 1 day", aqInDays_other: "in {{count}} days",
  aqNothingBooked: "Nothing booked. Your next date starts here.",
  aqAgenda: "Agenda",
  abLaneEmpty_gig: "Shows you book land here, from hold to paid.",
  abLaneEmpty_recording: "Studio sessions you plan and pay for.",
  abLaneEmpty_release: "Singles, EPs, albums, videos. Out into the world.",
  aqQuoteTool: "Quote a gig",
  aqQuoteToolDesc: "Price one specific date, ready to send.",
  aqQuoteIntro: "Starts from your minimum rate, not from what the venue offers.",
  aqPickGig: "Which date?",
  aqNoGigs: "No open gigs yet. Add one from the Gigs lane and quote it here.",
  aqDepositPct: "Deposit to confirm",
  aqTheyWillSee: "What they see",
  aqTxTitle: "Show quote", aqTxYourShow: "Your show",
  aqTxFee: "Fee", aqTxDeposit: "Deposit to confirm ({{pct}}%)", aqTxBalance: "Balance on show day",
  aqYourNet: "Your net", aqAfterCommission: "after {{pct}}% commission",
  aqBelowMin: "Below your minimum of {{min}}. You'd be paying to play.",
  aqCopy: "Copy quote", aqCopied: "Copied", aqApply: "Save to gig",
}, true, true);
i18n.addResourceBundle("es", "translation", {
  aqUpNext: "Lo que sigue", aqToday: "Hoy",
  aqInDays_one: "en 1 día", aqInDays_other: "en {{count}} días",
  aqNothingBooked: "Nada agendado. Tu próxima fecha empieza aquí.",
  aqAgenda: "Agenda",
  abLaneEmpty_gig: "Las fechas que cierres caen aquí, de apartada a pagada.",
  abLaneEmpty_recording: "Las sesiones de estudio que planeas y pagas.",
  abLaneEmpty_release: "Sencillos, EPs, álbumes, videos. Hacia el mundo.",
  aqQuoteTool: "Cotizar una fecha",
  aqQuoteToolDesc: "Ponle precio a una fecha concreta, lista para enviar.",
  aqQuoteIntro: "Arranca de tu tarifa mínima, no de lo que ofrezca el venue.",
  aqPickGig: "¿Cuál fecha?",
  aqNoGigs: "Aún no hay fechas abiertas. Agrega una en el carril de Fechas y cotízala aquí.",
  aqDepositPct: "Anticipo para confirmar",
  aqTheyWillSee: "Lo que ellos ven",
  aqTxTitle: "Cotización de show", aqTxYourShow: "Tu show",
  aqTxFee: "Pago", aqTxDeposit: "Anticipo para confirmar ({{pct}}%)", aqTxBalance: "Resto el día del show",
  aqYourNet: "Tu neto", aqAfterCommission: "después de {{pct}}% de comisión",
